...
import marc.henrard.book.algorithmicdifferentiation.finance.SabrVolatilityFormula;
...
public class SabrVolatilityFormulaAnalysis {
  ...
  public void derivativesPerformance() {
    ...
    for (int looprep = 0; looprep < nbRep; looprep++) {
      ...
      System.out.println(5*nbTest + " SABR volatility: " + (endTime - startTime) + " ms");
    }
    // Performance note: volatility: 24-Dec-2014: On Mac Book Pro 2.6 GHz Intel Core i7: 70 ms for 5x200,000 functions.
    ...
    for (int looprep = 0; looprep < nbRep; looprep++) {
      ...
      endTime = System.currentTimeMillis();
      System.out.println(5*nbTest + " SABR volatility (AAD): " + (endTime - startTime) + " ms");
    }
    // Performance note: volatility AAD: 24-Dec-2014: On Mac Book Pro 2.6 GHz Intel Core i7: 260 ms for 5x200,000 functions.
    ...
    for (int looprep = 0; looprep < nbRep; looprep++) {
      ...
      endTime = System.currentTimeMillis();
      System.out.println(5*nbTest + " SABR volatility (AAD Automatic): " + (endTime - startTime) + " ms");
    }
    // Performance note: volatility AAD Automatic (no interpret/interpret): 
    //   24-Dec-2014: On Mac Book Pro 2.6 GHz Intel Core i7: 840/1220 ms for 5x200,000 functions.
    ...
    for (int looprep = 0; looprep < nbRep; looprep++) {
      ...
      endTime = System.currentTimeMillis();
      System.out.println(5*nbTest + " SABR volatility (AAD Automatic2): " + (endTime - startTime) + " ms");
    }
    // Performance note: volatility AAD Automatic (no interpret/interpret): 
